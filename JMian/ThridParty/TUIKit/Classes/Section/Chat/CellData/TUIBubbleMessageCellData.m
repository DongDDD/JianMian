...
//            _bubble = [UIImage imageNamed:@"me_bubble"];
...
//        NSString *path = [[[NSBundle mainBundle] resourcePath] stringByAppendingPathComponent:[NSString stringWithFormat:@"me_bubble"]];
        
//        sOutgoingBubble = [[[TUIImageCache sharedInstance] getResourceFromCache:(path)] resizableImageWithCapInsets:UIEdgeInsetsFromString(@"{30,20,22,20}") resizingMode:UIImageResizingModeStretch];
...
//        sOutgoingHighlightedBubble = [[[TUIImageCache sharedInstance] getResourceFromCache:path] resizableImageWithCapInsets:UIEdgeInsetsFromString(@"{30,20,22,20}") resizingMode:UIImageResizingModeStretch];
