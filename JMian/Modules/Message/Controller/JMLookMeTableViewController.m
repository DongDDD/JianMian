...
#import "JMLookMeTableViewCell.h"

@interface JMLookMeTableViewController ()

@end
static NSString *cellIdent = @"lookMeCellIdent";

@implementation JMLookMeTableViewController
