...
//    _data = data;
    _content.frame = CGRectMake(TTextMessageCell_Margin, TTextMessageCell_Margin, self.container.frame.size.width - 2 * TTextMessageCell_Margin, self.container.frame.size.height - 2 * TTextMessageCell_Margin);
//
    ...
    if(data.status == Msg_Status_Fail){
        ...
        _error.image = [UIImage imageNamed:@"break"];
    }
    else{
