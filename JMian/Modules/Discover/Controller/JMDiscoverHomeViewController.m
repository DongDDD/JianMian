...
@interface JMDiscoverHomeViewController ()<UICollectionViewDelegate,UICollectionViewDataSource,JMDiscoverCollectionViewCellDelegate,JMCityListViewControllerDelegate,PKPaymentAuthorizationViewControllerDelegate>
{
