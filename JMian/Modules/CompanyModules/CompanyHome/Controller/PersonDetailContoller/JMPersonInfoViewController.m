...
- (void)setRightBtnImageViewName:(NSString *)imageName  imageNameRight2:(NSString *)imageNameRight2 mageNameRight3:(NSString *)imageNameRight3  {
...
-(void)getData{
    ...
    [[JMHTTPManager sharedInstance] fetchJobInfoWithId:_user_job_id successBlock:^(JMHTTPRequest * _Nonnull request, id  _Nonnull responsObject) {
        if (responsObject[@"data"]) {
            ...
            [self setRightBtnImageViewName:@"collect"  imageNameRight2:@"jobDetailShare" mageNameRight3:@"pppp"];
            [self hiddenHUD];
        }else{
